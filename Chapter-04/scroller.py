#!/usr/bin/python3
#
# Chapter 04 - Overhead Scroller Example
# scroller.py
#
# This script is from the following book:
# Raspberry Pi Cookbook for Python Programmers by Tim Cox
# For details see the publisher Packt Pub.
# http://www.packtpub.com/raspberry-pi-cookbook-for-python-programmers
#
# The script requires the following image files:
# bg.gif, gold.gif, mark.gif, playerD/L/R/U.gif, wallH/V.gif
#
#
